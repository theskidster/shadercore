...
/**
 * Provides a type-neutral data buffer which is used to store the value of a uniform variable. This value will be retrieved at a later point as the desired 
 * data type and supplied to the current {@linkplain GLProgram shader program}.
 */
final class Uniform {
